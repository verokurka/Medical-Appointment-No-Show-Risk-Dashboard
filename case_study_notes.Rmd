...
I created an interactive Tableau dashboard to explore appointment no-show patterns by waiting time, SMS reminder status, age group, weekday, and neighbourhood appointment volume.

The dashboard highlights:
- Overall no-show rate and appointment volume
- No-show percentage by waiting time
- No-show percentage by age group
- SMS reminder patterns interpreted within waiting-time groups
- Neighbourhood-level patterns interpreted alongside appointment count

[View the Tableau dashboard](https://public.tableau.com/app/profile/ver.nica.kurka/vizzes)
